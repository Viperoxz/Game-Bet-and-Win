...
def history(screen, username, tyle, thongtin):
    ...
    Back_button1 = pygame.image.load('Image/History/back1.png').convert_alpha()
    Back_button1 = pygame.transform.scale(Back_button1,(300*tyle,150*tyle))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if L_arrow_rect.collidepoint(mouse) :
                    ...
                    DISPLAYSURF.blit(Back_button1,Back_button_rect)
                    click_sound.play()
