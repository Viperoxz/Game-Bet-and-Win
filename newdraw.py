...
def choose_track(screen,username,selection_track):
    ...
    Back = pygame.image.load('img/background-menus/buttons/7.png')
    Help = pygame.image.load('img/background-menus/buttons/4.png')
    Next = pygame.image.load('Image/assets/SetMenu/arrow1.png')

    Back1 = pygame.image.load('img/background-menus/buttons/07.png')
    Help1 = pygame.image.load('img/background-menus/buttons/04.png')
    Next1 = pygame.image.load('Image/assets/SetMenu/arrow2.png')
